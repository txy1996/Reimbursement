...
<form class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item">
        ...
        <label class="layui-form-label">项目名称</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.hotel_title }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">住宿地点</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.hotel_site }"/>
        </div>
        <label class="layui-form-label">住宿起日</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.hotel_first }"/>
        </div>
        <label class="layui-form-label">住宿止日</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.hotel_finish }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">住宿天数</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.hotel_days }"/>
        </div>
        <label class="layui-form-label">合计总额</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.hotel_quarterage }"/>
        </div>
        <label class="layui-form-label">提交时间</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.hotel_time }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
                ...
                <div class="layui-input-block">
                    <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.hotel_remarks }"/>
                </div>
    </div>
    <div class="layui-form-item">
