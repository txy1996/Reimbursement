...
<form class="layui-form layui-form-pane" action="./ApplyreimServlet" method="get" var="TravelInfoVo">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <type="text" name="username" lay-verify="required" class="layui-input">
             ${TrafficInfoVo.traffic_start }
        </div>
        <label class="layui-form-label">结束时间</label>
        <div class="layui-input-inline">
            <type="text" name="username" lay-verify="required" class="layui-input">
                  ${TrafficInfoVo.traffic_end }
        </div>
        <label class="layui-form-label">交通类型</label>
                <div class="layui-input-inline">
                    <type="text" name="username" lay-verify="required" class="layui-input">
                        ${TrafficInfoVo.traffic_type }
                </div>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">审批意见</label>
                ...
                <div class="layui-input-block">
                    <input type="text" name="ll" lay-verify="required" class="layui-input">
