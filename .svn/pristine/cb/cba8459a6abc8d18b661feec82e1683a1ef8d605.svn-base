...
<form class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item">
        ...
        <label class="layui-form-label">项目名称</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.traffic_titel }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">目的地</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.traffic_address }"/>
        </div>
        <label class="layui-form-label">出差起日</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.traffic_start }"/>
        </div>
        <label class="layui-form-label">出差止日</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.traffic_end }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">交通工具</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.traffic_type }"/>
        </div>
        <label class="layui-form-label">合计总额</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.traffic_money }"/>
        </div>
        <label class="layui-form-label">提交时间</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.traffic_time }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
                ...
                <div class="layui-input-block">
                    <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.traffic_remark }"/>
                </div>
    </div>
    <div class="layui-form-item">
