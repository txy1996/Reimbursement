...
<form class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item">
        ...
        <label class="layui-form-label">出差目标</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_target }"/>
        </div>
        <label class="layui-form-label">出差结果</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_result }"/>
                </div>
    </div>
    <div class="layui-form-item">
        ...
        <label class="layui-form-label">项目名称</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_title }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">出差地点</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_address }"/>
        </div>
        <label class="layui-form-label">出差起日</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_start }"/>
        </div>
        <label class="layui-form-label">出差止日</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_end }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">出差天数</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_date }"/>
        </div>
        <label class="layui-form-label">合计总额</label>
        <div class="layui-input-inline">
            <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_money }"/>
        </div>
        <label class="layui-form-label">提交时间</label>      
                <div class="layui-input-inline">
                   <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_time }"/>
                </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
                ...
                <div class="layui-input-block">
                    <input disabled="disabled" type="text" name="title" class="layui-input" value="${statusDetailVO.travel_remark }"/>
                </div>
    </div>
    <div class="layui-form-item">
